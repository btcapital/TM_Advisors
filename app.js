...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. LOADER LOGIC (Updated to skip on deep links)
    const loaderLine = document.getElementById('loader-line');
    const loader = document.getElementById('loader');

    // Check if the URL has a hash (e.g., #team, #contact)
    // If yes, hide loader immediately. If no, play the intro.
    if (window.location.hash) {
        ...
        const interval = setInterval(() => {
            ...
            if (loaderLine) loaderLine.style.width = Math.min(progress, 100) + '%';
            if (progress >= 100) {
    ...
    // 2.5 LOGO SCROLL LOGIC
    const logoLink = document.querySelector('.logo-link');
    if (logoLink) {
        logoLink.addEventListener('click', function(e) {
            const path = window.location.pathname;
            // Only scroll to top if we are already on the home page (index.html or root)
...
const teamData = {
    ...
    "andrew": {
        ...
        bio: `
            <p>Andrew Morgan, CPA, serves as the Chief Investment Officer of TM Advisors. In this role, Andrew is responsible for developing and communicating the firm’s investment strategy, conducting in-depth investment analysis, managing portfolio risk, and overseeing capital allocation decisions. He also leads the evaluation of new investment opportunities, ensuring the firm achieves strategic and financial objectives for clients.</p>
    ...
    "brett-quayle": {
        ...
        img: "Brett-gray.png",
        bio: `
            <p>Brett Quayle is the youngest son of Robert Quayle, the founder of Quayle Financial Group. Over the past 10 years, Brett, a CERTIFIED FINANCIAL PLANNER™, has worked with his father, Robert, to continue to establish a familial feel at Quayle Financial.</p>
    ...
    "robert-quayle": {
        ...
        img: "bob-q-gray.png",
        bio: `
            <p>Robert Quayle has been in the insurance finance business for over 40 years. Working side by side with his son Brett, they have recently merged their company to form Taylor & Morgan, Quayle Financial.</p>
    ...
    "brandon": {
        ...
        img: "bt_gray.jpg",
        bio: `
            <p>Brandon Taylor, CPA, is Tax & Finance Manager at TM Advisors, where he provides tax strategy and financial insight to the firm’s clients and internal teams. He supports complex tax planning, M&A-related analysis, due diligence, and tax compliance for individuals, partnerships, and investment entities.</p>
